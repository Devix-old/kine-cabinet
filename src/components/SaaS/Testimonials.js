    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Trusted by physiotherapy clinics worldwide
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            See what our customers have to say about how KineCabinet has 
            transformed their practice management.
          </motion.p>
        </div>
        ...
        >
          <div>
            ...
            <div className="text-gray-600">Active Clinics</div>
          </div>
          <div>
